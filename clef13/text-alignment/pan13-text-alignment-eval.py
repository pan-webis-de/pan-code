...
#    print 'Average Time (s)', avg_time
    ...
    sys.stderr.write(' "Recall" :"' + str('%.5f' % rec)  + '",');
    sys.stderr.write(' "Precision":"' + str('%.5f' % prec) + '",');
    sys.stderr.write(' "Granularity":"' + str('%.5f' % gran) + '",');
    sys.stderr.write(' "Documents":"' + str(num_files) + '"}');
