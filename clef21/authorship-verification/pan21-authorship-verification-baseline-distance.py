...
def main():
    parser = argparse.ArgumentParser(
        description='PAN-21 Cross-domain Authorship Verification task: Distance-based baseline')
    # data settings:
    ...
    if args.train:
        ...
        train(args.input_pairs + '/pairs.jsonl', args.input_truth + '/truth.jsonl', model_directory,
