...
class OutputVerifierTest(unittest.TestCase):
    """
    Tests output verifier for PAN21 Style Change Detection task
    """
    ...
    def test_file_content_task1_missing(self):
        ...
        solution = {'changes': [0, 0], 'paragraph-authors': [1, 1, 1]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-1.json')
        with open(solution_file_path, 'w') as fh:
    ...
    def test_file_content_task2_missing(self):
        ...
        solution = {'multi-author': 0, 'paragraph-authors': [1, 1, 1]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
    ...
    def test_file_content_task3_missing(self):
        """ test for missing task 3 solution in json - warning expected """
        ...
        with warnings.catch_warnings(record=True) as warnings_occurred:
            ...
            self.assertEqual(len(warnings_occurred), 1)
            self.assertTrue(issubclass(warnings_occurred[-1].category, SyntaxWarning))
            self.assertTrue("Task 3" in str(warnings_occurred[-1].message))
    ...
    def test_file_content_task2_format1(self):
        ...
        solution = {'multi-author': 0, 'changes': 2, 'paragraph-authors': [1, 1, 1]}
    ...
    def test_file_content_task2_format2(self):
        """ test for correct json format for task 2"""
        solution = {'multi-author': 0, 'changes': [0, 0], 'paragraph-authors': [1, 1, 1]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-problem-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
        self.assertEqual(output_verifier.get_solution_file_check_result(solution_file_path, '1', self.test_dir_name),
    ...
    def test_file_content_task2_length(self):
        ...
        solution = {'multi-author': 0, 'changes': [0, 0, 1], 'paragraph-authors': [1,1,1]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-problem-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
        self.assertEqual(output_verifier.get_solution_file_check_result(solution_file_path, '1', self.test_dir_name),
    ...
    def test_file_content_task3_format1(self):
        """ test for task 3 solution not being an array"""
        solution = {'multi-author': 0, 'changes': [0, 0], 'paragraph-authors': 2}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-problem-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
        self.assertEqual(output_verifier.get_solution_file_check_result(solution_file_path, '1', self.test_dir_name),
                         [output_verifier.ParseError.TASK3_INVALID_FORMAT])

    def test_file_content_task3_format2(self):
        """ test for correct json format for task 3"""
        solution = {'multi-author': 0, 'changes': [0, 0], 'paragraph-authors': [1, 1, 1]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-problem-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
    ...
    def test_file_content_task3_format3(self):
        """ test for array for task 3 only holding 0-5 author ids """
        solution = {'multi-author': 0, 'changes': [0, 1], 'paragraph-authors': [10, 0, 3]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-problem-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
        self.assertEqual(output_verifier.get_solution_file_check_result(solution_file_path, '1', self.test_dir_name),
    ...
    def test_file_content_task3_length(self):
        """ test whether length of task 3 array is correct """
        solution = {'multi-author': 0, 'changes': [0, 0], 'paragraph-authors': [1, 1, 2, 4]}
        solution_file_path = os.path.join(self.test_dir_name, 'solution-problem-1.json')
        with open(solution_file_path, 'w') as fh:
            json.dump(solution, fh)
        self.assertEqual(output_verifier.get_solution_file_check_result(solution_file_path, '1', self.test_dir_name),
                     [output_verifier.ParseError.TASK3_INVALID_LENGTH])
