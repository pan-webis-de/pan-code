...
CODES2={'DE','nl','essays';'DR','nl','reviews';'EE','en','essays';'EN','en','novels';'GR','gr','articles';'SP','es','articles'};
...
for i=1:size(TA_ALL,1)
    if size(TA_ALL{i,1},1)>0
        ...
        [~,~,AUC]=pan14_authorship_verification_eval_compute_roc(GA_ALL{i,1},TA_ALL{i,1});
