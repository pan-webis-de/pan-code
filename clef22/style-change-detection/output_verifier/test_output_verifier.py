...
class OutputVerifierTest(unittest.TestCase):
    """
    Tests output verifier for PAN22 Style Change Detection task
    """
    ...
    def test_file_content_task2_missing(self):
        ...
        with warnings.catch_warnings(record=True) as warnings_occurred:
            ...
            warnings.simplefilter("always")
            output_verifier.get_solution_file_check_result(
                solution_file_path, "1", self.test_dir_name, output_verifier.Task.TASK2
            )
    ...
    def test_file_content_task3_missing(self):
        ...
        with warnings.catch_warnings(record=True) as warnings_occurred:
            ...
            warnings.simplefilter("always")
            output_verifier.get_solution_file_check_result(
                solution_file_path, "1", self.test_dir_name, output_verifier.Task.TASK3
            )
    ...
    def test_file_content_task2_format2(self):
        ...
        solution = {"paragraph-authors": [1, 1, 2]}
        solution_file_path = os.path.join(self.test_dir_name, "solution-problem-1.json")
        with open(solution_file_path, "w") as fh:
            json.dump(solution, fh)
        self.assertEqual(
    ...
    def test_file_content_task1_format3(self):
        """test for task 1 solution holding more than one 1"""
        solution = {"changes": [1, 0, 1]}
        solution_file_path = os.path.join(self.test_dir_name, "solution-1.json")
        with open(solution_file_path, "w") as fh:
            json.dump(solution, fh)
        self.assertEqual(
    ...
    def test_file_content_task1_format4(self):
    ...
    def test_file_content_task2_format4(self):
        """test for array for task 3 only holding 0-5 author ids"""
        solution = {"paragraph-authors": [10, 0, 3]}
        solution_file_path = os.path.join(self.test_dir_name, "solution-problem-1.json")
        with open(solution_file_path, "w") as fh:
            json.dump(solution, fh)
        self.assertEqual(
    ...
    def test_file_content_task2_length(self):
        ...
        solution = {"paragraph-authors": [1, 1, 2, 4]}
        solution_file_path = os.path.join(self.test_dir_name, "solution-problem-1.json")
        with open(solution_file_path, "w") as fh:
            json.dump(solution, fh)
        self.assertEqual(
