...
def compute_score_multiple_predictions(truth_values, solution_values, key, labels):
...
def main():
    ...
    task1_result = compute_score_multiple_predictions(task1_truth, task1_solutions, 'changes', labels=[0, 1])
    ...
    task2_results = compute_score_multiple_predictions(task2_truth, task2_solutions, 'paragraph-authors', labels=[1,2,3,4,5])
    ...
    task3_results = compute_score_multiple_predictions(task3_truth, task3_solutions, 'changes', labels=[0, 1])
