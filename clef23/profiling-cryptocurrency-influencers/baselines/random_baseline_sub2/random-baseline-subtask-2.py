...
LABELS=['other', 'technical information', 'trading matters', 'price update', 'gaming']
...
def main():
    parser = argparse.ArgumentParser(description='This is a baseline for subtask2 influencer interest identification.')
