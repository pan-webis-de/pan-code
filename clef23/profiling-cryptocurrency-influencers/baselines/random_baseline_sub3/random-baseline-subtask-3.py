...
LABELS=['announcement', 'subjective opinion', 'financial information', 'advertising']
...
def main():
    parser = argparse.ArgumentParser(description='This is a baseline for subtask3 influencer intent identification.')
