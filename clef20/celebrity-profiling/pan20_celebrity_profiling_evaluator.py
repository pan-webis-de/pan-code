...
def is_valid(pred, tr):
    """ Check if there are pred for each celebrity in the respective dataset
    and if all traits occur in the pred"""
...
if __name__ == "__main__":
    ...
    for k, v in {"c_rank": harmonic_mean([f1_gender, f1_occupation, f1_age]),
